...
// ─── API CONFIGURATION ────────────────────────────────────────────────────────
const API_CONFIG = {
  baseUrl: process.env.REACT_APP_API_BASE_URL || "https://geobrain.com.br/public-api/auth/login",
  credentials: {
...
class GeoBrainApiService {
  constructor() {
    this.token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwczovL2dlb2JyYWluLmNvbS5ici9wdWJsaWMtYXBpL2F1dGgvbG9naW4iLCJpYXQiOjE3NzAwNDA2OTgsImV4cCI6MTc3MDA1MTQ5OCwibmJmIjoxNzcwMDQwNjk4LCJqdGkiOiJHU1Z6T1ZMQXhualpVOU1IIiwic3ViIjoiMTE5MCJ9.MekM3c9QWte3_Bae9NZ7HYq3zxTYuQfEgAj4q1YKMXw";
  ...
  async ensureValidToken() {
    if (this.isTokenExpired()) {
      throw new Error("Token expirado. Por favor, atualize o token.");
    }
    return this.token;
  }
  ...
  async request(endpoint, options = {}) {
    ...
    if (res.status === 401) {
      throw new Error("Token inválido ou expirado. Não autorizado.");
    }
